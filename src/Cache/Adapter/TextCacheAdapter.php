...
/*
 * This file is nearly identical to DoctrineDbalAdapter, tweaked for use with Sqlite JSON and TEXT, like HTML
 */

namespace Survos\Scraper\Cache\Adapter;
...
class TextCacheAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function addTableToSchema(Schema $schema): void
    {
        ...
        $table->addColumn($this->dataCol, Types::TEXT); // goes to CLOB, not BLOB
